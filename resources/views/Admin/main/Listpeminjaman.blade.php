                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            {{-- <a href={{route('delete-peminjaman', $item->id)}}  class="btn btn-danger btn-sm tombol-del">Delete</a> --}}
                                        </td>
...
<div class="modal-dialog modal-dialog-centered modal-dialog-centered modal-dialog-scrollable"
    ...
    <div class="modal-content">
        ...
        <form action="{{ route('verif_pengembalian_diterima', $item1->id) }}" method="POST">
            ...
            <div class="modal-body">
                <p class="text-center">
                    Perhatian !!!
                    Anda yakin verifikasi pengambalian buku ?
                </p>
